...
class nnUNetTrainer(NetworkTrainer):
    ...
    def get_basic_generators(self):
        ...
        #                           pad_mode="constant", pad_sides=self.pad_all_sides, memmap_mode='r')
        #else:
        dl_tr = DataLoader2D(self.dataset_tr, (256,256), np.array([256, 256]).astype(int)[1:], 36,
                                 oversample_foreground_percent=self.oversample_foreground_percent,
                                 pad_mode="constant", pad_sides=[256,256], memmap_mode='r')
        dl_val = DataLoader2D(self.dataset_val, (256,256), np.array([256, 256]).astype(int)[1:], 36,
                                  oversample_foreground_percent=self.oversample_foreground_percent,
                                  pad_mode="constant", pad_sides=[256,256], memmap_mode='r')
        return dl_tr, dl_val
